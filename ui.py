...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.progressBar_2.setProperty("value", 99)
        ...
        self.progressBar_5.setProperty("value", 99)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_number2.setText(_translate("MainWindow", "按页数爬取："))
        self.label_time2.setText(_translate("MainWindow", "按时间爬取(月)："))
        ...
        self.label_number3.setText(_translate("MainWindow", "按页数爬取："))
        self.llabel_time3.setText(_translate("MainWindow", "按时间爬取(月)："))
